...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FURNACE_RELAY_Pin FAN_RELAY_Pin MAX31855_CS_Pin LCD_D7_Pin
                           LCD_RS_Pin LCD_E_Pin LCD_D4_Pin LCD_D5_Pin
                           LCD_D6_Pin */
  GPIO_InitStruct.Pin = FURNACE_RELAY_Pin|FAN_RELAY_Pin|MAX31855_CS_Pin|LCD_D7_Pin
                          |LCD_RS_Pin|LCD_E_Pin|LCD_D4_Pin|LCD_D5_Pin
                          |LCD_D6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
